function eval = getRAGMergeSegments(combFeat, tmpLabImg, thOptions, parNormal, parColor, rgnb, allInfoSI, scale, MethodType)
...
if(strcmp(MethodType, 'rb_jcsa_rm'))
    ...
    eval = removeSmallObjectsFinally_VMFMM(newLabels, parNormalT, rgnbT);
end