function newLabelsT = removeSmallObjectsFinally_VMFMM(tmpLabImg, parNormal, rgnb)
...
for t_segNum=1:totalNumRegions
    ...
    if(prb < thPrb)
        ...
        parNormalT = updateMergedRegionParametersVMFMM(parNormalT, parNormalT, [t_segNum t_segToMerge], t_segToMerge);
